"use strict";(self.webpackChunkstrapi=self.webpackChunkstrapi||[]).push([[720],{40216:(rt,U,s)=>{s.d(U,{S:()=>$});var t=s(92132),_=s(63891),p=s(94061),G=s(48653),m=s(83997),S=s(30893);const F=(0,_.default)(p.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
...
`,N=(0,_.default)(p.a)`
  ...
  width: 100%;
  border: none;
`,$=({children:x,icon:X,...z})=>(0,t.jsxs)("div",{children:[(0,t.jsx)(G.c,{}),(0,t.jsx)(N,{as:"button",background:"primary100",padding:5,...z,children:(0,t.jsxs)(m.s,{children:[(0,t.jsx)(F,{"aria-hidden":!0,background:"primary200",children:X}),(0,t.jsx)(p.a,{paddingLeft:3,children:(0,t.jsx)(S.o,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:x})})]})})]})},90720:(rt,U,s)=>{s.r(U),s.d(U,{default:()=>Nt});var t=s(92132),_=s(94061),p=s(83997),G=s(58805),m=s(30893),S=s(35513),F=s(26127),N=s(90361),$=s(33363),x=s(85963),X=s(40216),z=s(88353),dt=s(55356),ct=s(4198),d=s(21247),ht=s(68802),R=s(5194),Q=s(41909),_t=s(50612),pt=s(41231),ut=s(77701),gt=s(54514),ft=s(46270),j=s(2600),mt=s(412),J=s(56336),Y=s(39404),I=s(54894),w=s(17703),W=s(21272),r=s(34455),E=s(63891),kt=s(14718),Zt=s(48147),Vt=s(48940),Gt=s(77160),Xt=s(21835),wt=s(17024),Ht=s(51187),Qt=s(12083),Jt=s(94710),Yt=s(14311),qt=s(82437),te=s(89102),ee=s(5409),se=s(35336),ne=s(71547),oe=s(58692),ae=s(71210),ie=s(5790),le=s(35223),re=s(45635);const Et=(0,E.default)(_.a)`
  table {
    width: 100%;
    white-space: nowrap;
  }
...
`,yt=({component:e,dzName:n,index:o,isActive:a=!1,isInDevelopmentMode:c=!1,onClick:l})=>{const{modifiedData:u,removeComponentFromDynamicZone:C}=(0,r.u)(),{schema:{icon:y,displayName:M}}=j(u,["components",e],{schema:{}}),g=i=>{i.stopPropagation(),C(n,o)};return(0,t.jsxs)(Mt,{alignItems:"center",direction:"column",className:a?"active":"",borderRadius:"borderRadius",justifyContent:"center",paddingLeft:4,paddingRight:4,shrink:0,onClick:l,role:"tab",tabIndex:a?0:-1,cursor:"pointer","aria-selected":a,"aria-controls":`dz-${n}-panel-${o}`,id:`dz-${n}-tab-${o}`,children:[(0,t.jsx)(xt,{icon:y,isActive:a}),(0,t.jsx)(_.a,{marginTop:1,maxWidth:"100%",children:(0,t.jsx)(m.o,{variant:"pi",fontWeight:"bold",ellipsis:!0,children:M})}),c&&(0,t.jsx)(et,{as:"button",onClick:g,children:(0,t.jsx)(ht.A,{})})]})},Dt=(0,E.default)(R.A)`
  width: ${(0,d.a8)(32)};
  height: ${(0,d.a8)(32)};
  padding: ${(0,d.a8)(9)};
...
`,Pt=(0,E.default)(p.s)`
  ...
  justify-content: center;
  align-items: center;
`,Tt=({customRowComponent:e,components:n=[],addComponent:o,name:a,targetUid:c})=>{const{isInDevelopmentMode:l}=(0,r.u)(),[u,C]=(0,W.useState)(0),{formatMessage:y}=(0,I.A)(),M=i=>{u!==i&&C(i)},g=()=>{o(a)};return(0,t.jsx)(q,{className:"dynamiczone-row",isFromDynamicZone:!0,children:(0,t.jsxs)("td",{colSpan:12,children:[(0,t.jsx)(jt,{paddingLeft:8,children:(0,t.jsxs)(Ct,{gap:2,children:[l&&(0,t.jsx)("button",{type:"button",onClick:g,children:(0,t.jsxs)(Pt,{direction:"column",alignItems:"stretch",gap:1,children:[(0,t.jsx)(Dt,{}),(0,t.jsx)(m.o,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:y({id:(0,r.g)("button.component.add"),defaultMessage:"Add a component"})})]})}),(0,t.jsx)(p.s,{role:"tablist",gap:2,children:n.map((i,h)=>(0,t.jsx)(yt,{dzName:a||"",index:h,component:i,isActive:u===h,isInDevelopmentMode:l,onClick:()=>M(h)},i))})]})}),(0,t.jsx)(Ot,{children:n.map((i,h)=>{const f={customRowComponent:e,component:i};return(0,t.jsx)(_.a,{id:`dz-${a}-panel-${h}`,role:"tabpanel","aria-labelledby":`dz-${a}-tab-${h}`,style:{display:u===h?"block":"none"},children:(0,t.jsx)("table",{children:(0,t.jsx)("tbody",{children:(0,W.createElement)(tt,{...f,isFromDynamicZone:!0,component:c,key:i})})})},i)})})]})})},vt=(0,E.default)(_.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
